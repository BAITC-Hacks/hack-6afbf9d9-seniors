...
При запуске открывается главное меню с тремя кнопками: **«Начать»**, **«Настройки»**, **«Выйти из симулятора»**. После «Начать» доступны ровно три варианта: **«Сюжет»**, **«Свободный режим»**, **«Вернуться в меню»**. Свободный режим можно запустить сразу, без прохождения истории. Во время работы с симулятором кнопка «Главное меню» находится в верхней панели. Возвращение в меню и выход не сбрасывают решения.
...
История доступна на русском, казахском и английском. Сохранение версии 3 запоминает сцену, кадр пролога, ID принятых мер, лимиты, расследования и решение совета; старые сохранения версий 1 и 2 переносятся автоматически и продолжаются с текущего места. В старом прохождении лимиты не вводятся до открытия планирования. Чтобы пройти расширенную историю с начала, нажмите **«Начать историю заново»** и подтвердите сброс истории. Отчёты и свободный симулятор сохраняются отдельно.
