...
При запуске открывается главное меню с тремя кнопками: **«Начать»**, **«Настройки»**, **«Выйти из игры»**. После «Начать» доступны ровно три варианта: **«Сюжет»**, **«Свободный режим»**, **«Вернуться в меню»**. Свободный режим можно запустить сразу, без прохождения истории. Во время игры кнопка «Главное меню» находится в верхней панели. Возвращение в меню и выход не сбрасывают решения.
