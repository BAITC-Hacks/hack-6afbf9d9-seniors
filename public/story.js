...
const text = {
  ...
  freePlay: ['Играть в свободном режиме', 'Еркін режимде ойнау', 'Play in free mode'],
  ...
  unavailable: ['Данные мероприятия недоступны. Перезагрузите игру.', 'Шара деректері қолжетімсіз. Ойынды қайта жүктеңіз.', 'Initiative data is unavailable. Reload the game.'],
